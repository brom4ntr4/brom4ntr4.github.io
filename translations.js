const translations = {
  en: {
    ...
    "work.kh.tagline": "Services marketplace (web + mobile)",
    "work.kh.desc": "A public services marketplace connecting people with verified local providers across Morocco — the web companion to the Khdima mobile app. Built with Next.js 16, React 19 and Supabase, it's bilingual (French + Moroccan Darija with full RTL) and features a provider directory, category search, and public profiles with ratings, verification badges and contact requests.",
  ...
  fr: {
    ...
    "work.indev": "En développement",
    "work.kh.tagline": "Marketplace de services (web + mobile)",
    "work.kh.desc": "Une marketplace de services qui met en relation les particuliers avec des prestataires locaux vérifiés partout au Maroc — le pendant web de l'application mobile Khdima. Construite avec Next.js 16, React 19 et Supabase, elle est bilingue (français + darija marocain avec RTL complet) : annuaire de prestataires, recherche par catégorie et profils publics avec notes, badges de vérification et demandes de contact.",
  ...
  es: {
    ...
    "work.indev": "En desarrollo",
    "work.kh.tagline": "Marketplace de servicios (web + móvil)",
    "work.kh.desc": "Un marketplace de servicios que conecta a particulares con proveedores locales verificados en todo Marruecos — la versión web de la app móvil Khdima. Construida con Next.js 16, React 19 y Supabase, es bilingüe (francés + dariya marroquí con RTL completo): directorio de proveedores, búsqueda por categoría y perfiles públicos con valoraciones, sellos de verificación y solicitudes de contacto.",
